# GitHub Copilot — Bootloader Only
...
Do not start any task, write any work order, or touch git before reading them.
Do not duplicate rules into this file — `rules/` is the single source of truth
(rule 045).
