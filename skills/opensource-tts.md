...
> ۱. هر اسکریپتِ تولیدِ صدا باید **سقفِ حافظه** داشته باشد (۸–۱۰GB) — بخشِ
>    «سقفِ حافظه» در انتهای همین فایل. اجرای بی‌سقف مک را هنگ می‌کند.
...
### لایه ۲ — نگهبانِ فرایند (stdlib، بدون وابستگی)
