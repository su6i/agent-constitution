...
location: skills/github-code-quality.md
...
Utilizing a custom script to verify that every file in the project adheres to the `agent-constitution` and project-specific `rules`.
