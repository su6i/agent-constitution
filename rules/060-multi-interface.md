...
location: rules/060-multi-interface.md
agent_priority: High
...
- `rules/lang/python/fastapi.md` — FastAPI-specific coding rules (routers, async, schemas)
- `rules/010-python.md` — Python standards (uv, ruff, mypy)
